[![Luke Whipple](https://github.com/LukeWhipple/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/LukeWhipple/GithubActions/actions/workflows/run-app.yaml)
